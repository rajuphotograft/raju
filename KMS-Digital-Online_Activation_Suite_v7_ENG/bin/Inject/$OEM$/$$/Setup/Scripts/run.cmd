...
if %Debug% EQU 0 (
  ...
  @echo on
  @prompt $G
  @call :Activationact >"!logpath!.tmp" 2>&1 &cmd /u /c type "!logpath!.tmp">"!logpath!Debug.log"&del "!logpath!.tmp"
)
exit /b
::===============================================================================================================
:Activationact
...
SET Win10Gov=0
if %winbuild% LSS 14393 goto :Startact
...
FOR %%A IN (Cloud,CloudN) DO (IF /I "%EditionWMI%"=="%%A" GOTO :Startact)
SET EditionID=%EditionWMI%
FOR %%A IN (EnterpriseG,EnterpriseGN) DO (IF /I "%EditionID%"=="%%A" SET Win10Gov=1)
::===============================================================================================================
:Startact
